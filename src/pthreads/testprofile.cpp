...
/*
g++ -std=c++17 src/pthreads/profile.pbs.cpp src/schema/profile.pb.cc src/pthreads/testprofile.cpp -lprotobuf -lpthread -O3 -o src/pthreads/testprofile && src/pthreads/testprofile
*/
